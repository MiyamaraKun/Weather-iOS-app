...
//  sample
//
//  Created by Adityapal Waraich on 2024-05-04.
//
...
//        }
    ...
    func fetchCurrentWeather(latitude: Double, longitude: Double) async {
            let urlString = "https://api.open-meteo.com/v1/forecast?latitude=\(latitude)&longitude=\(longitude)&hourly=temperature_2m,weather_code&timezone=America%2FLos_Angeles&forecast_days=2&format=flatbuffers"
